// app/dashboard/customers/[customerExternalId]/vehicles/[vin]/page.tsx
  ...
  return (
    <main className="mx-auto max-w-4xl p-6 space-y-6">
      <div className="text-sm">
        <Link
          href={`/dashboard/customers/${encodeURIComponent(customerExternalId)}`}
          className="underline"
        >
          ← Back to customer
        </Link>
      ...
      <header className="space-y-1">
        ...
        >
          ...
          <input type="hidden" name="customerExternalId" value={customerExternalId} />
          <button
            type="submit"
